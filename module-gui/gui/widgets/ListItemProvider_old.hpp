...
namespace gui
{
    ...
    /// something between cache and factory for list view - it provides next elements requested by ListView_old
    ...
    {
      protected:
        ListView_old *list = nullptr;

      public:
        ListItemProvider_old();
        virtual ~ListItemProvider_old();
