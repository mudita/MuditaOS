...
namespace gui::status_bar
{
    ...
    bool SIMDevelopersMode::setEnabled(bool enable)
    {
        return StatusBarWidgetBase<Image>::setEnabled(enable);
    }
}; // namespace gui::status_bar
