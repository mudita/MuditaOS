...
public:
	...
	/**
	 * @brief Creates new context using provided coordinates. If there is no common part Context with 0 width and 0 height is returned.
	 */
	...
	inline uint16_t getW() {return w; };
	inline uint16_t getH() {return h; };
