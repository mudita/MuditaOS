...
namespace atag
{
    namespace detail
    {
        ...
        template <typename InputIt> uint32_t parse_syncsafe_int(InputIt it) noexcept
        {
            uint32_t t = 0;
        ...
        template <typename T, typename InputIt> T parse_syncsafe(InputIt it) noexcept
        {
            T t = 0;
        ...
        template <typename T, typename OutputIt> void write_syncsafe(T t, OutputIt it) noexcept
        {
         ...
         */
        template <typename T, typename InputIt> constexpr T parse_be(InputIt it) noexcept
        {
            T h = 0;
         ...
         * bytes.
         */
        template <typename T, typename InputIt> constexpr T parse_le(InputIt it) noexcept
        {
            T h = 0;
            for (auto i = 0; i < int(sizeof h); ++i) {
