...
namespace audio
{
    ...
    class ProfilePlaybackEarspeaker : public Profile
    {
      public:
        ProfilePlaybackEarspeaker(Volume volume)
            : Profile(
                  "Playback Earspeaker",
                  Type::RoutingEarspeaker,
                  purefs::dir::getUserDiskPath() / "data/equalizer/earspeaker_playback.json",
