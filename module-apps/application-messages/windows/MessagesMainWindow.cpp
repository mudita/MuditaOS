...
//	setFocusItem( list );
	...
	//record.body = UTF8("Elo taki to dlugi bedzie smsm zeby sie wyslal w kilku wiadomosciach i tak dalej piszemy co by nie było za mało");
	record.body = UTF8("Elo  mało");
