...
//    }
//
//    void PhonebookListView::refreshPage()
//    {
//
...
//            // if it's null it means that this is favourite label of label connected with showing Capital letters for
//            // surnames
//            int index = firstIndex, prevIndex = -1;
//            lastIndex = firstIndex;
//            for (int i = 0; i < listPageSize; i++) {
//                ListItem *item = provider->getItem(index, firstIndex, prevIndex, listPageSize);
//
//                if (item != nullptr) {
//                    addWidget(item);
...
//            if ((lastIndex == elementsCount - 1) && (visibleElements != listPageSize) && (firstIndex != 0)) {
//
//                orientation = ORIENTATION_BOTTOM_UP;
//
...
//                for (int i = 0; i < listPageSize; i++) {
//                    ListItem *item =
//                        provider->getItem(index, lastIndex, prevIndex, listPageSize, listPageSize - 1 - i, false);
//
//                    if (item != nullptr) {
//                        addWidget(item);
//                        items.push_back(item);
...
//            firstIndex = 0;
//
//        // calculate height of the item using list's height and listPageSize
//        uint32_t itemWidth = widgetArea.w;
//        if (drawVerticalScroll)
//            itemWidth -= 10;
//
//        // substract listPageSize for 1 pixel separators
//        int availableHeight = widgetArea.h - listPageSize;
//        if (availableHeight < 0)
//            availableHeight = 0;
//        int itemHeight = availableHeight / listPageSize;
//
