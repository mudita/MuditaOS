...
NewContactModel::NewContactModel(app::Application *app)
{
    ...
    internalData.push_back(new gui::InputBoxWithLabelAndIconItem(phonebookInternals::ListItemName::AddToFavourites));

    internalData.push_back(new gui::InputBoxWithLabelAndIconItem(phonebookInternals::ListItemName::AddToICE));
