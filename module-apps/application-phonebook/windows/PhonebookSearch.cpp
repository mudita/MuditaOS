...
void PhonebookSearch::buildInterface()
{
    ...
    searchResultList = new gui::PhonebookListView(this,
                                                  phonebookStyle::search::searchResultList::x,
                                                  phonebookStyle::search::searchResultList::y,
                                                  phonebookStyle::search::searchResultList::w,
                                                  phonebookStyle::search::searchResultList::h);
