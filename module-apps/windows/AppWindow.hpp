...
namespace gui
{
    ...
    class AppWindow : public Window
    {
      ...
      public:
        ...
        void headerIndicatorAdd(header::NavigationIndicator indicator);
        void headerIndicatorRemove(header::NavigationIndicator indicator);
        [[nodiscard]] bool headerIndicatorVisible(header::NavigationIndicator indicator) const;
