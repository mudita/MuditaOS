    ...
    class Application : public sys::Service
    {
      public:
        enum class State
        {
            ...
            // provided launcher. The other possibility
            ...
            // request
            // in a blocking way the db configuration of the phone. Before exiting the init handler application must
            // send APP_REGISTER message to
            // Application Manager.
            // Application Manager: Initialization is triggered by the switch message sent by other application to the
            // application manager.
            // Launcher for the application has been executed upon receiving switch command. Optional switch data has
            // been
            ...
            // acknowledge message.
            // Application must start closing all workers and releasing resources. After all workers are closed and
            // resources released application
            // sends to application manager CLOSING_FINISHED message
            // Application Manager sent signal to application that it should be closed. Application must perform all
            // necessary cleanup
      ...
      public:
        ...
        /**
         * Generic function for returning to switch window in active application without performing initialization of
         * the window.
         */
      ...
      protected:
        ...
        bool startBackground = false;
        /**
         * Flag defines whether application initialized suspend mode, this will influence how render message will sent
         * to gui service. If suspend is true, application manager will receive information from both eink and gui
