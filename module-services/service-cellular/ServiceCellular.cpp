    ...
    case MessageType::CellularHangupCall: {
        ...
        if (channel) {
            if (channel->cmd(at::AT::ATH)) {
                ...
                sys::Bus::SendMulticast(
                    std::make_shared<CellularNotificationMessage>(CellularNotificationMessage::Type::CallAborted),
                    sys::BusChannels::ServiceCellularNotifications,
                    this);
            }
            else {
...
CellularNotificationMessage::Type ServiceCellular::identifyNotification(const std::vector<uint8_t> &data,
                                                                        std::string &message)
{
