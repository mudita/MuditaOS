...
class ServiceCellular : public sys::Service
{
  public:
    ...
    static int32_t getSignalStrengthDB(int32_t strength)
    {
        return signalStrengthToDB[strength];
    }
    static int32_t getSignalStrengthDBRange()
    {
        return (sizeof(signalStrengthToDB) / sizeof(signalStrengthToDB[0]));
    }
  ...
  private:
    ...
    static constexpr int32_t signalStrengthToDB[] = {
        ...
        -109, // 1
        -109, // 2
        -107, -105, -103, -101, -99, -97, -95, -93, -91, -89, -87, -85, -83, -81, -79, -77, -75, -73, -71, -69, -67, -65, -63, -61, -59, -57, -55,
        -53 // 30
    };
