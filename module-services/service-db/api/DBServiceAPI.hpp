...
class DBServiceAPI
{
  ...
  public:
    ...
    static std::unique_ptr<std::vector<SMSRecord>> SMSGetLimitOffset(sys::Service *serv, uint32_t offset,
                                                                     uint32_t limit);
    static std::unique_ptr<std::vector<SMSRecord>> SMSGetLimitOffsetByThreadID(sys::Service *serv, uint32_t offset,
    ...
    static std::unique_ptr<std::vector<ThreadRecord>> ThreadGetLimitOffset(sys::Service *serv, uint32_t offset,
                                                                           uint32_t limit);
     ...
     */
    static ContactVerificationError verifyContact(sys::Service *serv, const ContactRecord &rec, ContactRecord &errName,
                                                  ContactRecord &errPhone1, ContactRecord &errPhone2,
                                                  ContactRecord &speedDial);

    static std::unique_ptr<std::vector<ContactRecord>> ContactGetByName(sys::Service *serv, UTF8 primaryName,
    ...
    static std::unique_ptr<std::vector<AlarmsRecord>> AlarmGetLimitOffset(sys::Service *serv, uint32_t offset,
                                                                          uint32_t limit);
