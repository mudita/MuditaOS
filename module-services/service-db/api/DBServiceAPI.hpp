...
class DBServiceAPI
{
  public:
    ...
    static uint32_t SMSGetCount(sys::Service *serv, SMSState state = SMSState::ALL);
    /**
    ...
    static uint32_t CalllogGetCount(sys::Service *serv, CallState state = CallState::ALL);
