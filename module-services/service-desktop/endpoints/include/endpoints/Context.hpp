...
namespace sdesktop::endpoints
{
    ...
    class Context
    {
      ...
      public:
        ...
        virtual auto createSimpleResponse(const std::string &entryTitle = json::entries) -> json11::Json
        {
            ...
            return json11::Json{std::move(contextJsonObject)};
        }

        auto setResponse(ResponseContext r)
        {
    ...
    class PagedContext : public Context
    {
      ...
      public:
        ...
        auto createSimpleResponse(const std::string &entryTitle = json::entries) -> json11::Json override
        {
    ...
    {
      public:
        static auto create(json11::Json &js) -> std::unique_ptr<Context>
        {
