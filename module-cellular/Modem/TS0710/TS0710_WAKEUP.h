 ...
 * multiplexer channel this is indicated to the TS 0710 layer in the receiving unit by means of the response primitive. Sins
 * the wakeup routine is initiated by the transmitting device attempting to communicate, neither request nor confirm
