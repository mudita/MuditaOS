...
TS0710::ConfState TS0710::ConfProcedure()
{
    ...
    parser->cmd(at::AT::CALLER_NUMBER_PRESENTATION); // per Quectel_EC25&EC21_AT_Commands_Manual_V1.3.pdf timeout should
                                                     // be set to 15s
    ...
    */
    ...
    if (c != nullptr) {
        ...
        if (res) {
            ...
            auto msg = std::make_shared<CellularNotificationMessage>(static_cast<CellularNotificationMessage::Type>(
