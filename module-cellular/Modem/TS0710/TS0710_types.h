...
enum TypeOfFrame_e { SABM = 0x3F, UA = 0x73, DM = 0x1F, DISC = 0x53, UIH = 0xEF, UI = 0x03, I };
...
struct DLC_ESTABL_SystemParameters_t {
        ...
        int MaxFrameSize;               //!< Maximum Frame Size [1 – 32768, default: 31 for the basic option and 64 for the advanced option]
