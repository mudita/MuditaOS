...
#define DEBUG_BLUETOOTH_HCI_COMS     0 /// show coms with BT module. Verbosity: 1 (stack+events), 2 (xfers), 3 (bytes)
#define DEBUG_BLUETOOTH_HCI_BYTES    0 /// show coms with BT module. Verbosity: 1 (stack+events), 2 (xfers), 3 (bytes)
