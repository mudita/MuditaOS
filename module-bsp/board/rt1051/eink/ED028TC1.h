...
#define EINK_FLAG_POWER_OFF_IN_PROGRESS         0x0002      ///< This flag informs that the Power Off sequence is in progress. 1 - in progress
#define EINK_FLAG_POWER_ON_IN_PROGRESS          0x0004      ///< This flag informs that the Power On sequence is in progress. 1 - in progress
#define EINK_FLAG_ENTIRE_FRAME_RECEIVED         0x0008      ///< This flag informs that the driver received data for entire frame defined in the \ref EinkDataStartTransmissionWindow command
...
#define EINK_FLAG_DISP_REFRESH_IN_PROGRESS      0x0400      ///< This flag informs that the Display Refreshing process is in progress
#define EINK_FLAG_AUTO_MEASURE_VCOM_IN_PROGRESS 0x0800      ///< This flag informs that the auto measurement of the VCOM is in progress
...
/**
 * @brief This function sends the part of image from the given buffer to the internal memory of the display. It makes not screen to update.
...
/**
 * @brief This function sets the waveform to the \ref EinkWaveformINIT to make the display clearing more deep and sends the white background
 ...
 *                                  EinkDisplayTimingsHighContrastMode - if image is displayed in the high contrast mode
 *                                  EinkDisplayTimingsFastRefreshMode - if image is to be displayed fast
 *
 * @return EinkOK
 */
EinkStatus_e
