...
#define MTP_FORMAT_3GP_CONTAINER                                                                                       \
    0xB984 // 3GPP file format. Details: http://www.3gpp.org/ftp/Specs/html-info/26244.htm (page title -
           // \u201cTransparent end-to-end packet switched streaming service, 3GPP file format\u201d).
...
#define MTP_FORMAT_ABSTRACT_MEDIACAST                                                                                  \
    0xBA0B // For use with mediacasts; references multimedia enclosures of RSS feeds or episodic content
