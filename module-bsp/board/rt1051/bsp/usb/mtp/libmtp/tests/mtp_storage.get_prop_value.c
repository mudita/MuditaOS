...
static mtp_object_info_t info = {
    ...
    .modified         = 1580323100,
    .size             = 0xabcdbeef,
    .uuid = {0x01, 0x02, 0x03, 0x04, 0x01, 0x02, 0x03, 0x04, 0x01, 0x02, 0x03, 0x04, 0x01, 0x02, 0x03, 0x04},
};
...
{
    expect(put_string, when(text, is_equal_to_contents_of("file", 5)), will_return(5));
...
{
    expect(put_date, when(time, is_equal_to(1580322989)), will_return(11));
...
{
    expect(put_date, when(time, is_equal_to(1580323100)), will_return(11));
...
{
    uint8_t expected[] = {0x03, 0x00, 0x00, 0xE0};
