...
static const mtp_device_info_t device_info = {
    .manufacturer = "Manufacturer", .model = "Model", .version = "1.0.0", .serial = "10000000000000000000000000000001"};
...
Ensure(mtp_dataset, device_info)
{
    ...
    expect(put_string, when(text, is_equal_to_contents_of("Model", 5)), will_return(1 + 6 * 2)); /* Model */
    expect(put_string, when(text, is_equal_to_contents_of("1.0.0", 5)), will_return(1 + 5 * 2)); /* Version */
    expect(put_string,
