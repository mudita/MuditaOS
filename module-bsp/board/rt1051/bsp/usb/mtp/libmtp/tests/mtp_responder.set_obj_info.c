...
const uint8_t operation_request[] = {0x14, 0x00, 0x00, 0x00, 0x01, 0x00, 0x0c, 0x10, 0xe2, 0x03,
...
{
    const uint8_t request[] = {0x14, 0x00, 0x00, 0x00, 0x01, 0x00, 0x0c, 0x10, 0x0F, 0x00,
                               0x00, 0xF0, 0x01, 0x00, 0x01, 0x00, 0xFF, 0xFF, 0xFF, 0xFF};
...
{
    const uint8_t request[] = {0x14, 0x00, 0x00, 0x00, 0x01, 0x00, 0x0c, 0x10, 0x0F, 0x00,
                               0x00, 0xF0, 0x01, 0x01, 0x00, 0x01, 0xFF, 0xFF, 0xFF, 0xFF};
    error                   = mtp_responder_handle_request(mtp, request, sizeof(request));
    given_length            = mtp_responder_get_data(mtp);
...
Ensure(set_object_info, data_returns_error_if_dataset_is_wrong)
{
    const uint8_t request[] = {
        0x5c, 0x00, 0x00, 0x00, 0x02, 0x00, 0x0c, 0x10, 0xe2, 0x03, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00,
        0x04, 0x30, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x0c, 0x77, 0x00, 0x65, 0x00, 0x6c, 0x00, 0x63, 0x00, 0x6f, 0x00, 0x6d, 0x00, 0x65, 0x00, 0x2e,
        0x00, 0x74, 0x00, 0x78, 0x00, 0x74, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    };

    expect(
        deserialize_object_info, when(data, is_equal_to(&request[12])), when(length, is_equal_to(80)), will_return(-1));
...
Ensure(set_object_info, data_calls_storage_api_and_returns_error_if_format_not_supported)
{
    ...
    expect(
        deserialize_object_info, when(data, is_equal_to(&request[12])), when(length, is_equal_to(80)), will_return(0));
    expect(is_format_code_supported, will_return(false));
...
Ensure(set_object_info, data_calls_storage_api_and_returns_error_if_fail)
{
    ...
    expect(
        deserialize_object_info, when(data, is_equal_to(&request[12])), when(length, is_equal_to(80)), will_return(0));
    expect(mock_create, will_return(-1));
...
Ensure(set_object_info, data_returns_ok_if_file_created)
{
    ...
    expect(
        deserialize_object_info, when(data, is_equal_to(&request[12])), when(length, is_equal_to(80)), will_return(0));
    expect(mock_create, will_return(0));
    expect(is_format_code_supported, will_return(true));
