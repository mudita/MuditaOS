...
namespace bsp
{
    class RT1051Cellular : public Cellular
    {
      private:
        ...
        void logData(std::string title, uint8_t *buffer, size_t nbytes);
      ...
      public:
        ...
        static constexpr std::size_t RXdmaBufferSize = 64;
        static std::size_t RXdmaMaxReceivedCount;

        static constexpr std::uint32_t startIRQMaskEnable =
            kLPUART_RxActiveEdgeInterruptEnable | kLPUART_RxDataRegFullInterruptEnable;
        static constexpr std::uint32_t finishIRQMaskEnable = kLPUART_IdleLineInterruptEnable;
        static constexpr std::uint32_t startIRQMask        = kLPUART_RxActiveEdgeFlag | kLPUART_RxDataRegFullFlag;
        static constexpr std::uint32_t finishIRQMask       = kLPUART_IdleLineFlag;
      ...
      private:
        ...
        static constexpr std::uint16_t rxMessageBufferOverheadSize            = 4;
