...
namespace gui
{
    ...
    void HomeScreenLayoutClassicWithQuotes::buildInterface()
    {
        ...
        // date->setMaximumSize(style::homescreen_classic::status_box_layout_w,
        // style::bell_base_layout::outer_layouts_h); date->setAlignment(Alignment(Alignment::Horizontal::Left,
        // Alignment::Vertical::Center)); date->setFont(mainWindow::bottomDescription::font_normal);
