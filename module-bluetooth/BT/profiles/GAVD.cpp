    ...
    if((id) && (AUD_Event_Data))
    {
        ...
        switch(AUD_Event_Data->Event_Data_Type)
        {
            case etAUD_Open_Request_Indication:
                ...
                LOG_INFO("ConnectionRequestType: %d", AUD_Event_Data->Event_Data.AUD_Open_Request_Indication_Data->ConnectionRequestType);
                break;
...
//                {
//                    LOG_INFO("MediaMTU:    %d", AUD_Event_Data->Event_Data.AUD_Stream_Open_Confirmation_Data->MediaMTU);
//
...
//                }
            ...
            case etAUD_Stream_Close_Indication:
                ...
                LOG_INFO("DisconnectReason: %d", AUD_Event_Data->Event_Data.AUD_Stream_Close_Indication_Data->DisconnectReason);
...
//                }
            ...
            case etAUD_Remote_Control_Close_Indication:
                ...
                LOG_INFO("BD_ADDR:          %s", tmp.tostr().c_str());
                LOG_INFO("DisconnectReason: %d", AUD_Event_Data->Event_Data.AUD_Remote_Control_Close_Indication_Data->DisconnectReason);
                break;
...
//                    ReconfigureA3DPStream(&(AUD_Event_Data->Event_Data.AUD_Stream_Format_Change_Indication_Data->StreamFormat));
            ...
            case etAUD_Signalling_Channel_Close_Indication:
                ...
                LOG_INFO("BD_ADDR:  %s", tmp.tostr().c_str());
                LOG_INFO("DisconnectReason: %d", AUD_Event_Data->Event_Data.AUD_Signalling_Channel_Close_Indication_Data->DisconnectReason);
                break;
            default:
