...
static const size_t xHeapStructSize =
    (sizeof(BlockLink_t) + ((size_t)(usermemBYTE_ALIGNMENT - 1))) & ~((size_t)usermemBYTE_ALIGNMENT_MASK);
...
static void prvInsertBlockIntoFreeList(BlockLink_t *pxBlockToInsert)
{
    ...
    for (pxIterator = &userxStart; pxIterator->pxNextFreeBlock < pxBlockToInsert;
